...
Stream.prototype.merge = function (s2) {
  ...
  return this.isEmpty ? s2 : this.isAbort ? this : this.isCons ? Stream.Cons(this.head, this.tail.merge(s2)) : !s2.isFuture ? s2.merge(this) : Stream.Future(_utils.raceLP([this.promise.then(function (s) {
    return function () {
      return s.merge(s2);
    };
...
Stream.prototype.debounce = function (event) {
  ...
  }, Stream.Abort)) : Stream.Future(_utils.raceLP([event().then(function (_) {
    return function () {
